...
import ar.edu.uncuyo.videojuegos.mapper.BaseMapper;
import ar.edu.uncuyo.videojuegos.repository.BaseRepository;
...
public abstract class BaseService<
    ...
    public Page<SummaryDto> findDtos(Pageable pageable) {
        Page<E> entities = repository.findByActiveTrue(pageable);
